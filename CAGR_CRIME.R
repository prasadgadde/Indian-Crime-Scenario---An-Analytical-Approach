data<-read.csv("/home/prasadgadde/Documents/BigData/Project/crimes_all.csv")
df<-data.frame(data)
df<-df[,4:33]
...
write.csv(cagrdf, file = "/home/prasadgadde/Documents/BigData/Project/cagrdf_crime.csv")
